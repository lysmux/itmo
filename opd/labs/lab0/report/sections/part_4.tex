...
\begin{minted}[breaklines]{shell}
[s467213@helios ~/opd/lab0/lab0]$ ls -Rl 2> /dev/null | grep "^[-l]" | grep ":[0-6][0-9] .*da" | sort -rk6 | head -n4
...
\begin{minted}[breaklines]{shell}
[s467213@helios ~/opd/lab0/lab0]$ ls -laR 2> /tmp/136_err | grep "^[-l]" | grep ":[0-6][0-9] .*ldu" | sort -k6 | head -n2
