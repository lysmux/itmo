package dev.lysmux.server.parser.arg;

import dev.lysmux.server.parser.arg.exception.ArgParseException;
import dev.lysmux.server.parser.arg.exception.ParserNotFoundException;
...
public class ArgParser {
    ...
    public <T> T parse(String arg, Class<T> type) {
        ...
        try {
            ...
            throw new ArgParseException(arg, type);
        }
    }
