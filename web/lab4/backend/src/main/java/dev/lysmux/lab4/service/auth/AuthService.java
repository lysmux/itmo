...
public class AuthService {
    ...
    private String generateRefreshToken(String userId) {
        RefreshToken token = tokensRepository.addToken(new RefreshToken(false));

        return generateToken(token.id(), Map.of("userId", userId), REFRESH_TOKEN_EXPIRATION_MS);
    }
