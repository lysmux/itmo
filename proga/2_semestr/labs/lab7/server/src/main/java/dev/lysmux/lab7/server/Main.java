...
import dev.lysmux.lab7.server.command.GetCommandsCommand;
import dev.lysmux.lab7.server.command.HelpCommand;
import dev.lysmux.lab7.server.command.admin.ExitCommand;
import dev.lysmux.lab7.server.command.auth.LoginCommand;
import dev.lysmux.lab7.server.command.auth.RegisterCommand;
import dev.lysmux.lab7.server.command.collection.*;
import dev.lysmux.lab7.common.command.CommandRegistry;
import dev.lysmux.lab7.server.config.Config;
import dev.lysmux.lab7.server.config.ConfigLoader;
import dev.lysmux.lab7.server.repository.LabWorkRepository;
import dev.lysmux.lab7.server.repository.UserRepository;
import dev.lysmux.lab7.server.network.Server;
import dev.lysmux.lab7.server.network.TCPServer;
