package dev.lysmux.lab7.common.command.wrapper;

import dev.lysmux.lab7.common.command.Command;
import dev.lysmux.lab7.common.command.exception.CouldNotExecuteCommand;
import dev.lysmux.lab7.common.command.exception.InvalidCommandException;
...
public class LocalCommandWrapper implements CommandWrapper {
    ...
    public boolean requiresLogin() {
        return annotation.requiresLogin();
    }
